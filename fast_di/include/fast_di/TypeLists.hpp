...
namespace Utilities::TypeTraits
{
...
<
    ...
    typename... Tail
>
constexpr auto for_each_impl(Processor&& processor)
{
    ...
    {
        return for_each_impl<Processor, Tail...>(std::forward<Processor>(processor));
    }
}
...
<
    ...
    typename Processor
>
constexpr auto for_each(Pack<TypeList...>&&, Processor&& processor)
{
    return Private::for_each_impl<Processor, TypeList...>(std::forward<Processor>(processor));
}
