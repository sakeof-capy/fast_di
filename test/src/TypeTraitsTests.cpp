...
using Utilities::TypeTraits::pack_concatenate_t;
...
TEST(StaticTypeTraitsTests, PackFilterNonEmpty)
{
...
TEST(StaticTypeTraitsTests, PackFilterEmpty)
{
...
TEST(StaticTypeTraitsTests, ForEach)
{
...
TEST(StaticTypeTraitsTests, PackConcatenate)
{
